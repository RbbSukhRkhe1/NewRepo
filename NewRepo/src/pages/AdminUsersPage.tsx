  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <h1 className="font-display text-2xl font-bold text-white">Users &amp; wallets</h1>
        <Link
          to="/admin/users/new"
          className="font-display rounded-full bg-gradient-to-r from-teal-400 to-teal-500 px-4 py-2 text-sm font-semibold text-[#041214]"
        >
